-- Question 1: To transform the ProductDetail table into 1NF, I'll create a new table where each row represents a single product for an order, eliminating the multi-valued Products column:
